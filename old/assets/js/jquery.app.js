...
!function($) {
    ...
    Sidemenu.prototype.openLeftBar = function() {
      ...
      var hButton = $('#leftPanelArrow');
      if($("#wrapper").hasClass("enlarged") && $("body").hasClass("fixed-left")) {
          $("body").removeClass("fixed-left").addClass("fixed-left-void");
    
          hButton.removeClass('ion-chevron-left');
          hButton.addClass('md-dehaze');
      } else if (!$("#wrapper").hasClass("enlarged") && $("body").hasClass("fixed-left-void")) {

          $("body").removeClass("fixed-left-void").addClass("fixed-left");
          hButton.removeClass('md-dehaze');
          hButton.addClass('ion-chevron-left');
      }
...
//              if(e.target.className !== 'form-control chat-input' 
//              &&e.target.className !== 'conversation-text'
//              &&e.target.className !== 'md md-chat'
//               &&e.target.className !== 'conversation-list nicescroll'
