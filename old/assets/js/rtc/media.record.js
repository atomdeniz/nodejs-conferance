...
$(document).ready(function () {
    ...
    api.post(serviceUrl + '/InterviewApi/CheckUser', dataToPost, function (response) {
        ...
        if (response.HasDone) {
            ...
            chat.client.checkRoomUsers = serverEvents.checkRoomUsers;
            chat.client.echoPrivateMessage = serverEvents.echoPrivateMessage;
            chat.client.echoPublicMessage = serverEvents.echoPublicMessage;

            chat.client.startRecord = serverEvents.startRecord;
            chat.client.joinInterview = serverEvents.joinInterview;
            chat.client.pauseRecord = serverEvents.pauseRecord;
            chat.client.resumeRecording = serverEvents.resumeRecording;
            chat.client.endInterview = serverEvents.endInterview;

            chat.client.updateVideoId = serverEvents.updateVideoId;

            chat.client.addInterviewNote = serverEvents.addInterviewNote;
            chat.client.deleteInterviewNote = serverEvents.deleteInterviewNote;
            chat.client.updateInterviewNote = serverEvents.updateInterviewNote;
            chat.client.moveInterviewNote = serverEvents.moveInterviewNote;
            chat.client.connectionUserAlive = function (roomKey, userKey) {
            ...
            chat.client.connectionKeyRequested = function (roomKey, userKey, adminKey, applyerKey, listenerKey) {
                if (roomKey !== window.credential.RoomKey) {
                    return;
                }
                window.credential.Users.forEach(function (user, key) {
            ...
            chat.client.updateRecordingStatus = function () {
